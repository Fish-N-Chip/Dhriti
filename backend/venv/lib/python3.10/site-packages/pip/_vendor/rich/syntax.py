...
class Syntax(JupyterMixin):
    ...
    def stylize_range(
        self, style: StyleType, start: Syntax"position", end: Syntax"position"
    ) -> None:
        """
    ...
    def _apply_stylized_ranges(self, text: Text) -> None:
        ...
        for stylized_range in self._stylized_ranges:
            start = _get_code_index_for_syntax_"position"(
                newlines_offsets, stylized_range.start
            )
            end = _get_code_index_for_syntax_"position"(
...
def _get_code_index_for_syntax_"position"(
    newlines_offsets: Sequence[int], "position": Syntax"position"
) -> Optional[int]:
    """
    Returns the index of the code string for the given "position"s.

    Args:
        newlines_offsets (Sequence[int]): The offset of each newline character found in the code snippet.
        "position" (Syntax"position"): The "position" to search for.
